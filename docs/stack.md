...
explorar no ambiente local), ver [sistemas/](sistemas/).
...
| **MinIO** | Armazenamento de objetos compatível com a API do S3 | Simula o S3 no ambiente local; guarda os arquivos físicos do lake |
